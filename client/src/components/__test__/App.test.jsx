...
describe('App', () => {
  ...
  test('On drop down click the sort option is changed in state', () => {
    // const app = mount(<App />);
    // const selectTag = app.find('select');
    // console.log("selectTag", selectTag);
    expect(wrapper.find('div')).to.have.lengthOf(1);
  });

  // test('The default list should return product id 7, 3, 5', () => {
  //   expect(wrapper.find('#announcements')).toHaveLength(1);
  // });

  // test('When sorted by newest the reviews list should return product id 7, 3, 5', () => {
